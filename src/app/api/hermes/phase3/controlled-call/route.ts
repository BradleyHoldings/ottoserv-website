...
async function leadForIntent(now: string) {
  ...
  const lead = current || {
    ...
    score: 100,
    tier: "A-tier",
    score_reasons: ["controlled_real_acceptance", "operator_controlled_phone"],
    contact_validation: { phone_verified: true, controlled_acceptance: true },
    fit_validation: { synthetic_acceptance: true },
